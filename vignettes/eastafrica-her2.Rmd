...
The following code tries to reproduce the default analysis in the Shiny app based on the example in the [introduction]() vignette.
```{r default}
...
These results are now close to those obtained in the app. More precisely, it
